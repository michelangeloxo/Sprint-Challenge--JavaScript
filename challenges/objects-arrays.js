...
const universities = graduates.map((object, index, arr)=>{
...
const contactInfo = [];
graduates.forEach((object, index, arr)=>{
  let GraduateInfo = object.first_name + " " + object.email;

  contactInfo.push(GraduateInfo);})
